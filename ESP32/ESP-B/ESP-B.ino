...
const int waterlvl = 4;

Adafruit_SHT31 sht31 = Adafruit_SHT31(); //Create an Adafruit SHT31 object
BH1750 lightMeter(0x23);

// lowest and highest waterlevel sensor readings:
const int waterlevelMin = 1800;     // sensor minimum
const int waterlevelMax = 2100;  // sensor maximum
...
void readsensor() {
  ...
  waterlevel_sensor = digitalRead(waterlvl);// check water level in humidifier tank
