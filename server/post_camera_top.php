...
$upload_dir = '/opt/lampp/htdocs/SGC/camera_upload/camera_top';  //directory to save pictures
$name = basename($_FILES["top_camera"]["name"]); //filename
...
if (!move_uploaded_file($_FILES["top_camera"]["tmp_name"], $target_file)){
    echo "error";
}
else {
...
$deleted = $row["top_camera_filename"];	
