...
$upload_dir = '/opt/lampp/htdocs/SGC/camera_upload/camera_back';  //directory to save pictures
$name = basename($_FILES["back_camera"]["name"]); //filename
...
if (!move_uploaded_file($_FILES["back_camera"]["tmp_name"], $target_file)){
    echo "error";
}
else {
...
$deleted = $row["back_camera_filename"];	
